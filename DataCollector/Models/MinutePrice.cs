...
{
    /// <summary>
    /// 분봉 데이터 모델 (DataCollector 전용)
    /// StockTrader3.Models.MinutePrice와 동일한 구조
    /// </summary>
    public class MinutePrice
    {
        ...
        /// <summary>
        /// 날짜 및 시간 (예: 2025-06-04 14:30:00)
        /// </summary>
        public DateTime DateTime { get; set; }

        /// <summary>
        /// 분봉 간격 (1, 3, 5, 10, 15, 30, 60분)
        /// </summary>
        ...
        /// <summary>
        /// StockTrader3.Models.MinutePrice로 변환
        /// (향후 StockTrader3에서 사용할 때 필요)
        /// </summary>
        public StockTrader3.Models.MinutePrice ToStockTrader3Model()
        {
            return new StockTrader3.Models.MinutePrice
            {
                Id = this.Id,
                ...
                TradingValue = this.TradingValue,
